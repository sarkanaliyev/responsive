...
import karvansarayarxiv from "../assets/k-w.jpeg";
import { useState } from "react";

export default function Detal2() {
  const isgalarray = [
    { name: "Işğaldan Sonra", img: karvansarayarxiv },
    { name: "Işğaldan Əvvəl", img: karvansaray },
    ...
    <div>
      ...
      <div className="right">
        ...
        <div className="main-div">
          ...
          <p className="detal-rayon">Füzuli</p>
